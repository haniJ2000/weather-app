...
import com.example.weather_l.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    class weatherTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String args[]) {
            String response = HttpRequest.excuteGet("https://api.openweathermap.org/data/2.5/weather?q="+CITY1+"&units=metric&appid=api key");
            return response;
        }
